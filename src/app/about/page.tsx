    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="max-w-4xl mx-auto mb-16">
        ...
        <p className="text-lg text-gray-700 text-center mb-8 leading-relaxed">
          Da oltre 50 anni, la Macelleria Paiano rappresenta l&apos;eccellenza
          nella tradizione della macelleria artigianale. La nostra famiglia si
          dedica con passione alla selezione delle migliori carni, garantendo
          qualità e autenticità in ogni taglio.
        </p>
      </section>
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-6">
              ...
              <h3 className="text-xl text-red-600 mb-4">{member.role}</h3>
