        ...
        <div className="container mx-auto px-4 py-36">
          ...
          <section className="max-w-4xl mx-auto mb-28">
            ...
            <p className="text-lg text-gray-700 text-center mb-8 leading-relaxed">
              Da oltre 50 anni, la Macelleria Casi rappresenta l&apos;eccellenza
              nella tradizione della macelleria artigianale. La nostra famiglia
              si dedica con passione alla selezione delle migliori carni,
              garantendo qualità e autenticità in ogni taglio.
            </p>
          </section>
          {/* Team Members */}
