...
emailjs.init({
    ...
    blockList: {
        ...
        watchVariable: "jordanromagnoli1999@gmail.com",
    },
    limitRate: {
        id: "app",
        throttle: 10000,
...
const ContactForm = () => {
    ...
    return (
        ...
        `}
            ...
            <div className="bg-white p-8 max-w-[600px] mx-auto">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={isSubmitting}
                        className="w-full bg-red-800 text-white py-3 px-6  hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                    >
                        {isSubmitting ? (
                            <>
                                <svg
